...
import { SERVICE_ENDPOINT, SERVICE_TYPE_LIST_ENDPOINT, SOFT_DELETE_ENDPOINT, } from '../endpoints.names';
import { CREATE_SERVICE, SOFT_DELETE, FETCH_SERVICE_DETAIL, FETCH_SERVICE_LIST, FETCH_SERVICE_TYPE_LIST, UPDATE_SERVICE_DETAIL } from '../actions.names';
